...
const CompanyInfoScreen = ({ navigation }: CompanyInfoScreenProps) => {
  ...
  const handleSaveCompanyInfo = async () => {
    // Validasyon
    if (!formData.companyName || !formData.companyAddress || !formData.companyPhone || !formData.taxNumber || !formData.taxOffice) {
      showAlert({
        title: 'Uyarı',
        message: 'Lütfen zorunlu alanları doldurun (Şirket Adı, Adres, Telefon, Vergi No, Vergi Dairesi).',
        type: 'warning',
      });
      return;
    }
    ...
    try {
      ...
      // Ek bilgileri form olarak kaydet
      ...
      showAlert({
        title: 'Başarılı',
        message: 'Şirket bilgileri başarıyla kaydedildi. Artık tüm özellikleri kullanabilirsiniz.',
        type: 'success',
        onConfirm: () => navigation.goBack(),
      });
    } catch (error: any) {
      console.error('[CompanyInfoScreen] Kayıt hatası:', error);
      
      let errorMessage = 'Şirket bilgileri kaydedilirken bir hata oluştu.';
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: theme.headerBackground }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.headerText }]}>Şirket Bilgileri</Text>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={[styles.infoCard, { backgroundColor: theme.card }]}>
            ...
            <Text style={[styles.infoText, { color: theme.textSecondary }]}>
              Şirket bilgilerini girerek tüm özellikleri kullanmaya başlayabilirsiniz.
            </Text>
          </View>
