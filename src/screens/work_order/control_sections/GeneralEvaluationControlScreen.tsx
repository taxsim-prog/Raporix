...
interface GeneralEvaluationControlScreenProps {
  navigation?: any;
  routeParams?: any;
  onDataUpdate: (data: any, isCompleted: boolean) => void;
}

const GeneralEvaluationControlScreen: React.FC<GeneralEvaluationControlScreenProps> = ({
  navigation,
  routeParams,
  onDataUpdate,
}) => {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>
            Bu bölümde sistemin genel durumu ve güvenlik tedbirleri değerlendirilir.
          </Text>
...
export default GeneralEvaluationControlScreen;
