...
interface HarmfulEffectsControlScreenProps {
  navigation?: any;
  routeParams?: any;
  onDataUpdate: (data: any, isCompleted: boolean) => void;
}

const HarmfulEffectsControlScreen: React.FC<HarmfulEffectsControlScreenProps> = ({
  navigation,
  routeParams,
  onDataUpdate,
}) => {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>
            Bu bölümde elektriksel ve elektriksel olmayan sistemler arasındaki zararlı etkiler değerlendirilir.
          </Text>
...
export default HarmfulEffectsControlScreen;
