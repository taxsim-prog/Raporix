...
interface IdentificationControlScreenProps {
  navigation?: any;
  routeParams?: any;
  onDataUpdate: (data: any, isCompleted: boolean) => void;
}

const IdentificationControlScreen: React.FC<IdentificationControlScreenProps> = ({
  navigation,
  routeParams,
  onDataUpdate,
}) => {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>
            Bu bölümde sistem tanımlama, etiketleme ve uyarı işaretleri kontrol edilir.
          </Text>
...
export default IdentificationControlScreen;
