...
interface PanelAccessControlScreenProps {
  navigation?: any;
  routeParams?: any;
  onDataUpdate: (data: any, isCompleted: boolean) => void;
}

const PanelAccessControlScreen: React.FC<PanelAccessControlScreenProps> = ({
  navigation,
  routeParams,
  onDataUpdate,
}) => {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>
            Bu bölümde pano ve diğer donanımlara erişimin uygunluğu değerlendirilir.
          </Text>
...
export default PanelAccessControlScreen;
