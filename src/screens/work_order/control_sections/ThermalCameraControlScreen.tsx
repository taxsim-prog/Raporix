...
interface ThermalCameraControlScreenProps {
  navigation?: any;
  routeParams?: any;
  onDataUpdate: (data: any, isCompleted: boolean) => void;
}

const ThermalCameraControlScreen: React.FC<ThermalCameraControlScreenProps> = ({
  navigation,
  routeParams,
  onDataUpdate,
}) => {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>
            Bu bölümde termal kamera ile sıcaklık ölçümleri ve termal görüntüleme kontrolleri yapılır.
          </Text>
...
export default ThermalCameraControlScreen;
